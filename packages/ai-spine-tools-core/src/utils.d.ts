...
export declare class ToolUtils {
     ...
     */
    static error(message: string, code?: string, details?: any): ToolExecutionResult;
    /**
     ...
     */
    static sanitizeConfig(config: Record<string, any>, secretFields?: string[]): Record<string, any>;
    /**

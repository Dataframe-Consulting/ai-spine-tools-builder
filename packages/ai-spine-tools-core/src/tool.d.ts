...
import { ToolDefinition, ToolExecutionContext, ToolExecutionResult, ToolMetadata, ToolSchema, ToolInput, ToolConfig } from './types.js';
/**
...
export declare class Tool<TInput = ToolInput, TConfig = ToolConfig> {
     ...
     * ```
     */
    test(input: TInput, config?: TConfig): Promise<{
        valid: boolean;
        errors?: string[];

 ...
 */
export type ToolInputFieldType = 'string' | 'number' | 'boolean' | 'array' | 'object' | 'date' | 'time' | 'datetime' | 'email' | 'url' | 'uuid' | 'json' | 'file' | 'enum';
/**
 * String format validation options for string-type fields.
 * These provide additional validation beyond basic string checking.
 */
export type StringFormat = 'email' | 'url' | 'uri' | 'uuid' | 'regex' | 'hostname' | 'ipv4' | 'ipv6' | 'base64' | 'jwt' | 'slug' | 'color-hex' | 'semver';
/**
 ...
 */
export type ToolConfigFieldType = 'string' | 'number' | 'boolean' | 'apiKey' | 'secret' | 'url' | 'enum' | 'json';
/**
...
export declare class ExecutionError extends ToolError {

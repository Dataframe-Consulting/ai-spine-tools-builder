 ...
 */
export declare function objectField(properties: Record<string, ToolInputField>): ObjectFieldBuilder;
/**
...
export declare class SchemaBuilder {
     ...
     */
    testField(fieldName: string, value: any, type?: 'input' | 'config'): Promise<ValidationResult>;
    /**
 ...
 */
export declare function validateField(field: ToolInputField | ToolConfigField, value: any, fieldName?: string, options?: ValidationOptions): Promise<ValidationResult>;
/**
...
export declare function createValidator(schema: {
     ...
     * Validate input data
     */
    validateInput: (data: any, options?: ValidationOptions) => Promise<ValidationResult<any>>;
    /**
     * Validate config data
     */
    validateConfig: (data: any, options?: ValidationOptions) => Promise<ValidationResult<any>>;
    /**
    ...
    validateToolData: (data: {
        input: any;
        config: any;
    }, options?: ValidationOptions) => Promise<ValidationResult<any>>;
    /**
...
export declare const validate: {
     ...
     */
    stringArray: (value: any, minItems?: number, maxItems?: number) => Promise<ValidationResult>;
};
export {};

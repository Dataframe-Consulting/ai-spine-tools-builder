 ...
 * ```
 */
import { ToolInputField, ToolConfigField, ToolInput, ToolConfig, ToolSchema } from './types.js';
/**
...
export declare class ZodSchemaValidator {
     ...
     */
    validateInput(input: ToolInput, schema: Record<string, ToolInputField>, _options?: ValidationOptions): Promise<ValidationResult>;
    /**
     * Validates tool configuration against the provided schema
     */
    validateConfig(config: ToolConfig, schema: Record<string, ToolConfigField>, _options?: ValidationOptions): Promise<ValidationResult>;
    /**
     * Validates complete tool schema including cross-field validations
     */
    validateToolSchema(data: {
        input: ToolInput;
        config: ToolConfig;
    }, schema: ToolSchema, _options?: ValidationOptions): Promise<ValidationResult>;
    /**
...
export declare class SchemaValidator {
     ...
     */
    static validateInput(input: ToolInput, schema: Record<string, ToolInputField>): Promise<void>;
    /**
     * @deprecated Use ZodSchemaValidator.validateConfig instead
     */
    static validateConfig(config: ToolConfig, schema: Record<string, ToolConfigField>): Promise<void>;
}
